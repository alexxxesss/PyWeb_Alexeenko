    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deadline', models.DateTimeField(default=todo.models.datetime_now_plus_one_day, verbose_name='Крайний срок')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
                ('todo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='todo.todo', verbose_name='Запись')),
            ],
            options={
